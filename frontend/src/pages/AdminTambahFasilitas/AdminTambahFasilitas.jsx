...
const AdminTambahFasilitas = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.detail || 'Gagal menambahkan fasilitas baru.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="facility-form-page">
        <div className="form-header-wrapper" style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
          ...
          <div className="form-header" style={{ margin: 0 }}>
            <h1 className="form-title" style={{ margin: 0 }}>Tambah Fasilitas Baru</h1>
            <p className="form-subtitle" style={{ margin: '4px 0 0 0' }}>Masukkan informasi detail untuk menambahkan fasilitas baru ke dalam sistem.</p>
          </div>
        </div>
          ...
          <div className="form-left-col">
            <div className="form-group">
              ...
              <input 
                ...
                placeholder="Contoh: Auditorium Andi Hakim Nasoetion" 
                value={formData.name}
            ...
            <div className="form-group">
              ...
              <textarea 
                ...
                placeholder="Tuliskan deskripsi lengkap fasilitas, keunggulan, dan peralatan yang tersedia..."
...
export default AdminTambahFasilitas;
